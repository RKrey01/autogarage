...
@Service
@RequiredArgsConstructor //zodat er een constructor word gemaakt met alle arguments (repositories)
@Transactional
@Slf4j
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    public User saveUser(User user) {
        ...
        user.setPassword(passwordEncoder.encode(user.getPassword())); //get pw of user, encode it and then set as pw
